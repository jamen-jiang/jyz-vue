<template>
  <jyz-container>
    ...
    <el-table :data="logLogins" row-key="Id" height='100%'>
      <el-table-column prop="UserName" label="登录账号"></el-table-column>
      <el-table-column prop="LoginOn" label="登录日期"></el-table-column>
      <el-table-column prop="IP" label="IP地址"></el-table-column>
      <el-table-column prop="Browser" label="浏览器"></el-table-column>
      <el-table-column prop="Os" label="操作系统"></el-table-column>
      <el-table-column prop="IsSuccess" label="登录状态">
...
export default {
  ...
  methods: {
    query() {
      ...
      this.$api.loglogin.query(data).then(res => {
        this.logLogins = res.Data.List;
